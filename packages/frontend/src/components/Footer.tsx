...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 border-t border-gray-200 dark:border-gray-700 mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-xl bg-gradient-to-r from-amber-600 to-orange-600 dark:from-amber-400 dark:to-orange-400 bg-clip-text text-transparent">
                Sunleaf
              </h3>
            </div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-white dark:bg-gray-800 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-white dark:bg-gray-800 hover:bg-pink-100 dark:hover:bg-pink-900/30 transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-white dark:bg-gray-800 hover:bg-sky-100 dark:hover:bg-sky-900/30 transition-colors"
                aria-label="Twitter"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-gray-900 dark:text-white">Навігація</h4>
          ...
          {/* Customer Service */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-gray-900 dark:text-white">Підтримка</h4>
            <ul className="space-y-3">
              {[
          ...
          {/* Contact */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-gray-900 dark:text-white">Контакти</h4>
            <ul className="space-y-3">
        ...
        <div className="pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 flex items-center gap-2">
              Зроблено з <Heart className="w-4 h-4 text-red-500 fill-red-500 animate-pulse" /> в Україні
            </p>

            <div className="flex gap-6">
              <a href="#" className="text-sm text-gray-600 dark:text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
